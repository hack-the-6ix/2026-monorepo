...
export const ETHNICITY_OPTIONS = [
  { label: 'East Asian (e.g. China, Japan, Korea)', value: 'East Asian (e.g. China, Japan, Korea)' },
  { label: 'South Asian (e.g. India, Pakistan, Sri Lanka)', value: 'South Asian (e.g. India, Pakistan, Sri Lanka)' },
  { label: 'White / People of European Descent', value: 'White / People of European Descent' },
  { label: 'Southeast Asian (e.g. Cambodia, Indonesia, Singapore)', value: 'Southeast Asian (e.g. Cambodia, Indonesia, Singapore)' },
  { label: 'Arab / Middle Eastern', value: 'Arab / Middle Eastern' },
  { label: 'Black/People of African Descent', value: 'Black/People of African Descent' },
  { label: 'Latinx', value: 'Latinx' },
  { label: 'Jewish', value: 'Jewish' },
  { label: 'Indigenous / First Nations', value: 'Indigenous / First Nations' },
  { label: 'Mixed / Multiracial', value: 'Mixed / Multiracial' },
  { label: 'Central Asian (e.g. Kazakhstan, Uzbekistan, Afghanistan)', value: 'Central Asian (e.g. Kazakhstan, Uzbekistan, Afghanistan)' },
  { label: 'Pacific Islander (e.g. Fiji, Samoa, Hawaii)', value: 'Pacific Islander (e.g. Fiji, Samoa, Hawaii)' },
  { label: 'West or Central Asian (eg. Afghanistan, Iran, Kazakhstan)', value: 'West or Central Asian (eg. Afghanistan, Iran, Kazakhstan)' },
  { label: 'Mixed / Multiracial', value: 'Mixed / Multiracial 2' },
